...
#ifdef __wasip3__
// No thread list lock needed on __wasip3__
void __tl_lock(void) {}
void __tl_unlock(void) {}
void __tl_sync(pthread_t td) {}

static void init_file_lock(FILE *f) {
  // No-op for WASIP3: cooperative locks don't need this initialization
  (void)f;
}
#else
...
int __pthread_create(pthread_t *restrict res,
   ...
   * wasip3-threads specification requires the module to export a
   * `wasip3_thread_start` function, which is invoked with `args`. */
